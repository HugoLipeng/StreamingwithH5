...
BrowserHistory = (function() {
    ...
    var historyFrameSourcePrefix = 'http://raspi.monaserver.ovh/MonaClients/VideoPlayer/history/history/historyFrame.html?';
    ...
    var _initialize = function () {
        ...
        if (browser.ie)
        {
            ...
            for (var i = 0, s; s = scripts[i]; i++) {
                if (s.src.indexOf("history.js"/*tpa=http://raspi.monaserver.ovh/MonaClients/VideoPlayer/history/history.js*/) > -1) {
                    var iframe_location = (new String(s.src)).replace("history.js"/*tpa=http://raspi.monaserver.ovh/MonaClients/VideoPlayer/history/history.js*/, "historyFrame.html"/*tpa=http://raspi.monaserver.ovh/MonaClients/VideoPlayer/history/historyFrame.html*/);
                }
            }
